  ...
  if (sent) {
    return (
      <motion.div
        ...
        className="rounded-2xl bg-sky p-10 text-center"
      >
        <CheckCircle2 className="mx-auto text-brand mb-4" size={40} />
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div>
        ...
        <select
          id="subject"
          className="w-full rounded-xl border border-line px-4 py-3 text-sm bg-white focus:border-brand outline-none"
      ...
      <div>
        ...
        <textarea
          ...
          className="w-full rounded-xl border border-line px-4 py-3 text-sm bg-white focus:border-brand outline-none resize-none"
        />
      </div>
