      ...
      <section className="section-pad">
        <div className="container-hc grid lg:grid-cols-2 gap-14 items-center">
          ...
          <Reveal delay={0.1}>
            ...
            <p className="text-[var(--hc-slate)] leading-relaxed mb-4">
        ...
        <div className="container-hc grid md:grid-cols-2 gap-6">
          <Reveal>
            <div className="h-full rounded-3xl bg-white p-9 card-shadow">
              ...
              <h3 className="font-display text-2xl font-semibold text-[var(--hc-navy)] mb-3">Our Vision</h3>
              <p className="text-[var(--hc-slate)] leading-relaxed">
          ...
          <Reveal delay={0.1}>
            <div className="h-full rounded-3xl bg-[var(--hc-navy)] text-white p-9 card-shadow">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {VALUES.map((v, i) => (
              <Reveal key={v.title} delay={i * 0.07}>
                <div className="h-full rounded-2xl border border-[var(--hc-line)] p-7 text-center hover:card-shadow transition-all">
                  <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-xl bg-[var(--hc-sky)] text-[var(--hc-blue)] mb-4">
                    <HeartHandshake size={20} />
                  </div>
                  <h3 className="font-semibold text-[var(--hc-navy)] mb-2">{v.title}</h3>
                  <p className="text-sm text-[var(--hc-slate)] leading-relaxed">{v.text}</p>
                </div>
              </Reveal>
            ))}
          </div>
      ...
      <section className="section-pad bg-[var(--hc-cream)]">
        <div className="container-hc grid lg:grid-cols-[1fr_1.2fr] gap-14 items-center">
          ...
          <Reveal delay={0.1}>
            ...
            <h2 className="font-display text-2xl sm:text-3xl font-semibold text-[var(--hc-navy)] mt-3 mb-5">
            ...
            <p className="text-[var(--hc-slate)] leading-relaxed mb-6">
            ...
            <p className="text-sm text-[var(--hc-slate)]">Board Chairperson</p>
          </Reveal>
        </div>
      </section>
              ...
              <Reveal key={t.name} delay={i * 0.06}>
                <div className="rounded-2xl overflow-hidden card-shadow bg-white">
                  ...
                  <div className="p-5">
                    ...
                    <p className="text-sm text-[var(--hc-blue)] font-medium">{t.role}</p>
                    <p className="text-xs text-[var(--hc-slate)] mt-1">{t.subject}</p>
                  </div>
                </div>
              </Reveal>
            ))}
      ...
      <section className="section-pad bg-[var(--hc-navy)] text-white">
        <div className="container-hc">
          <Reveal className="max-w-2xl mb-12">
            <span className="eyebrow text-[var(--hc-amber)]">Achievements</span>
            ...
            {ACHIEVEMENTS.map((a, i) => (
              <Reveal key={a} delay={i * 0.07}>
                <div className="flex gap-4 rounded-2xl bg-white/5 border border-white/10 p-6">
                  <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[var(--hc-amber)] text-[var(--hc-navy)]">
                    <Award size={18} />
                  </div>
